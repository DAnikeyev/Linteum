...
public class Program
{
    static async Task Main(string[] args)
    {
        if (args.Length == 0)
        {
            ...
            Console.WriteLine("Required env: BOT_PASSWORD (bot account password).");
            Console.WriteLine("Optional env: BOT_SERVICE_TOKEN to bypass Economy and Normal limits through batch painting.");
